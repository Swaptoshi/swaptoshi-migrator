...
export const NUMBER_ACTIVE_VALIDATORS_AFTER = 21;
export const NUMBER_ACTIVE_VALIDATORS_BEFORE = 51;
export const NUMBER_STANDBY_VALIDATORS = 2;
export const ROUND_LENGTH = NUMBER_ACTIVE_VALIDATORS_BEFORE + NUMBER_STANDBY_VALIDATORS;
